                    ...
                    <div class="col-lg-3">
                       <div class="widget widget_listing">
                            ...
                            <ul>
                                <li>
                                    <div class="featured">
                                        <a href="#" class="effect"><img src="{{ asset('images/flickr/7.jpg') }}" alt="image"></a>
                                    </div>
                                ...
                                <li>
                                    <div class="featured">
                                        <a href="#" class="effect"><img src="{{ asset('images/flickr/8.jpg') }}" alt="image"></a>
                                    </div>
                                    <div class="info-listing">
                        ...
                        <div class="widget widget_contact">
                            ...
                            <ul class="clearfix">                                
                                <li>
                                    <div class="thumb">
                                        <a href="#" class="effect">
                                            <img src="{{ asset('images/flickr/1.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </li>
                                <li>
                                    <div class="thumb">
                                        <a href="#" class="effect">
                                            <img src="{{ asset('images/flickr/2.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </li>
                                <li>
                                    <div class="thumb">
                                        <a href="#" class="effect">
                                            <img src="{{ asset('images/flickr/3.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </li>
                                <li>
                                    <div class="thumb">
                                        <a href="#" class="effect">
                                            <img src="{{ asset('images/flickr/4.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </li>
                                <li>
                                    <div class="thumb">
                                        <a href="#" class="effect">
                                            <img src="{{ asset('images/flickr/5.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </li>
                                <li>
                                    <div class="thumb">
                                        <a href="#" class="effect">
                                            <img src="{{ asset('images/flickr/6.jpg') }}" alt="image">
                                        </a>
                                    </div>
                                </li>
                            </ul>
