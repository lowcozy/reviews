...
<head>
    ...
    <title>@yield('title') - {{ config('app.name', 'Reviews') }}</title>
...
<body>
    <div class="wrapper" id="app">
        @php
            $username = Sentinel::getUser()->last_name . ' ' . Sentinel::getUser()->first_name;
        @endphp

        @include('Admin.includes.sidebar', ['username' => $username])
